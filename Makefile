...
# Temporary: Majora uses IDO until it is decompiled
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: CC           := $(ASM_PROC) $(ASM_PROC_FLAGS) tools/ido_recomp/$(DETECTED_OS)/7.1/cc -- $(AS) $(ASFLAGS) --
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: CFLAGS       := -G 0 -non_shared -Xcpluscomm -nostdinc -Wab,-r4300_mul
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: WARNINGS     := -fullwarn -verbose -woff 624,649,838,712,516,513,596,564,594,807
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: ASFLAGS      := -march=vr4300 -32 -G0
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: AS_DEFINES   := -D_MIPS_SZLONG=32 $(GBI_DEFINES) -DMIPSEB -D_LANGUAGE_ASSEMBLY -D_ULTRA64
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: C_DEFINES    := -D_MIPS_SZLONG=32 $(GBI_DEFINES) -D_LANGUAGE_C
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: ENDIAN       := -EB
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: OPTFLAGS     := -O2 -g3
$(BUILD_DIR)/src/overlays/actors/ovl_Boss_07/z_boss_07.o: MIPS_VERSION := -mips2
endif
